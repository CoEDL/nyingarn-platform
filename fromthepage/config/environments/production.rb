Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "fromthepage_production"
  ...
  config.action_mailer.default_url_options =  { host: ENV['SERVER_HOSTNAME'] } #change this to match your server URL, i.e. www.fromthepage.com
